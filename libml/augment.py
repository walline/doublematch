...
POLICIES = EasyDict(cifar10=policies.cifar10_policies(),
                    ...
                    cifar100_dp_weak_aug_0=policies.cifar10_policies(),
                    cifar100_dp_weak_aug_1=policies.cifar10_policies(),
                    cifar100_dp_weak_aug_2=policies.cifar10_policies(),
                    cifar100_dp_weak_aug_3=policies.cifar10_policies(),
                    cifar100_dp_weak_aug_4=policies.cifar10_policies())
...
DEFAULT_AUGMENT = EasyDict(
    ...
    svhn_noextra=AugmentPair(tf=lambda x: dict(image=Primitives.s(4)(x), label=x['label'], index=x.get('index', -1)),
                             numpy=AugmentPool),
    cifar100_dp=AugmentPair(tf=lambda x: dict(image=Primitives.ms(4)(x), label=x['label'], index=x.get('index', -1)),
                            numpy=AugmentPool),

    cifar100_dp_weak_aug_0=AugmentPair(tf=lambda x: dict(image=Primitives.ms(4)(x), label=x['label'],
                                                         index=x.get('index', -1)), numpy=AugmentPool),

    cifar100_dp_weak_aug_1=AugmentPair(tf=lambda x: dict(image=Primitives.ms(4)(x), label=x['label'],
                                                         index=x.get('index', -1)), numpy=AugmentPool),

    cifar100_dp_weak_aug_2=AugmentPair(tf=lambda x: dict(image=Primitives.ms(4)(x), label=x['label'],
                                                         index=x.get('index', -1)), numpy=AugmentPool),

    cifar100_dp_weak_aug_3=AugmentPair(tf=lambda x: dict(image=Primitives.ms(4)(x), label=x['label'],
                                                         index=x.get('index', -1)), numpy=AugmentPool),

    cifar100_dp_weak_aug_4=AugmentPair(tf=lambda x: dict(image=Primitives.ms(4)(x), label=x['label'],
                                                         index=x.get('index', -1)), numpy=AugmentPool),
