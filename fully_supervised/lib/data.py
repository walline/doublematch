...
def create_datasets():
    ...
    d.update([DataSetsFS.creator('cifar100_dp', ['cifar100-dp.tfrecord'], ['cifar100-test.tfrecord'], valid,
                                 augment_function, nclass=100) for valid in [5000]])
    
    d.update([DataSetsFS.creator('cifar100_dp_weak_aug_0',
                                 ['cifar100-dp_weak_aug_0.tfrecord'],
                                 ['cifar100-test.tfrecord'], valid,
                                 augment_function, nclass=100) for valid in [5000]])
    
    d.update([DataSetsFS.creator('cifar100_dp_weak_aug_1',
                                 ['cifar100-dp_weak_aug_1.tfrecord'],
                                 ['cifar100-test.tfrecord'], valid,
                                 augment_function, nclass=100) for valid in [5000]])
    
    d.update([DataSetsFS.creator('cifar100_dp_weak_aug_2',
                                 ['cifar100-dp_weak_aug_2.tfrecord'],
                                 ['cifar100-test.tfrecord'], valid,
                                 augment_function, nclass=100) for valid in [5000]])
    
    d.update([DataSetsFS.creator('cifar100_dp_weak_aug_3',
                                 ['cifar100-dp_weak_aug_3.tfrecord'],
                                 ['cifar100-test.tfrecord'], valid,
                                 augment_function, nclass=100) for valid in [5000]])
    
    d.update([DataSetsFS.creator('cifar100_dp_weak_aug_4',
                                 ['cifar100-dp_weak_aug_4.tfrecord'],
                                 ['cifar100-test.tfrecord'], valid,
                                 augment_function, nclass=100) for valid in [5000]])
